...
TimerClass::TimerClass(void)
{
   ...
   MoveSpeed				= 60;							// so moven wie bei 60 fps
   SpeedFaktor				= 0.0f;
...
void  TimerClass::update(void)
{
	...
	SpeedFaktor = (float)(MoveSpeed / aktuelleFramerate);
}

// --------------------------------------------------------------------------------------
// Maximum Framrate abwarten
// --------------------------------------------------------------------------------------
...
void TimerClass::SetMoveSpeed(int Wert)
{
	MoveSpeed = Wert;
}
...
int TimerClass::GetMoveSpeed(void)
{
	return MoveSpeed;
}
